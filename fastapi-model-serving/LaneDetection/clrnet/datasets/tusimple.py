...
class TuSimple(BaseDataset):
    def __init__(self, data_root, split, processes=None, cfg=None, ori_img_h=720, ori_img_w=1280, cut_height=160):
        super().__init__(data_root, split, processes, cfg)
        self.anno_files = SPLIT_FILES[split]
        self.load_annotations()
        self.h_samples = list(range(160, 720, 10)) # tusimple
        self.ori_img_h = ori_img_h
        self.ori_img_w = ori_img_w
        self.cut_height = cut_height
        # self.h_samples = list(range(160, 1080, 10))
