...
class CLRHead(nn.Module):
    ...
    def loss(self,
        ...
        targets = batch_copy['lane_line']
        seg_targets = batch_copy['seg']
        seg_targets = torch.clamp(seg_targets, max=6)
        ...
        for stage in range(self.refine_layers):
            ...
            for predictions, target in zip(predictions_list, targets):
                ...
                reg_pred = predictions[matched_row_inds, 6:].clone()
        ...
        # print("Unique values in seg_targets:", torch.unique(seg_targets))
        # print("Output seg shape:", output['seg'].shape)
        # print("Seg targets shape:", seg_targets.shape)
        # print("Seg targets dtype:", seg_targets.dtype)
